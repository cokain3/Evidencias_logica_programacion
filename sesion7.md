...
class Main {
  public static void main(String[] args) {
    ...
    //se declara el arrraylist tipo string de nombres
    ...
    // se imprimen los elementos del array
      ...
      // se añade un nuevo elemento en la posicion 1
      nombres.add(1, "Pablo");
    // se imprimen los elementos del array
      System.out.println(nombres); // [Ana, Pablo, Luisa, Felipe]         
    // se remueve el elemento en la posiccion 0
      nombres.remove(0);
    // se imprimen los elementos del array
      System.out.println(nombres); // [Pablo, Luisa, Felipe]
    // se reeemplaza el elemento que esta en la posisicon 0 por uno nuevo
      nombres.set(0,"Alfonso");
    // se imprimen los elementos del array
      System.out.println(nombres); // [Alfonso, Luisa, Felipe]     
    // se declaran 2 variables string para obtener el elemento en la posicion 1 y el   elemento en la ultima       
    //posicion 
